...
if __name__ == '__main__':
    ...
    # Read video
    video = cv2.VideoCapture("videos/Echo/echo4.mp4")
    ...
    print("Select the region to track, then press SPACE or ENTER")
    ...
    # Initialize all trackers with same bbox
